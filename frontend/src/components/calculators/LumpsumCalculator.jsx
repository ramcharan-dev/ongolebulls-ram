...
export default function LumpsumCalculator() {
  ...
  const results = useMemo(() => {
    const P = Math.max(0, Number(totalInvestment));
      ...
      <LeftSection>
        <InputGroup>
          <LabelRow>
            ...
            <ValueBadge>₹ {Intl.NumberFormat('en-IN').format(totalInvestment)}</ValueBadge>
          </LabelRow>
          <RangeInput 
            type="range" 
            min="5000" 
        ...
        <InfoNote>
          A Lumpsum investment is a large, single payment made at one time rather than broken up into instalments. Use this calculator to see how your one-time investment could grow over the years.
        </InfoNote>
      </LeftSection>
