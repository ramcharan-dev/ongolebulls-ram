import{n as C,j as o,l as ie,A as r,a8 as ae,N as le,r as n,c as ce,u as K,T as de,X as pe,U as M,S as xe,a as ue,Q as he,O as ge}from"./index-CBdPhbzg.js";import{d as fe,l as me}from"./theme-CVoCgdjI.js";import{X as E}from"./x-C3hjsG26.js";import{L as be,a as ye}from"./log-out-XNb9afVR.js";import{R as je}from"./receipt-Bq4k6gyE.js";import{F as $e}from"./file-text-BCEMemjf.js";import{U as W}from"./user-lrw9cISj.js";import{S as ve,M as ke}from"./send-DTp2qkCZ.js";import{S as X}from"./search-ejUTuyX_.js";import{c as we}from"./userApi-DQgUPuMd.js";import{u as Q}from"./useAuth-C1RP2Sk6.js";import{C as Ce,S as Se}from"./sparkles-CDbPHpap.js";import{C as ze}from"./chevron-down-BT-ZK-bZ.js";import{S as Me,M as Ie}from"./sun-CvwvmJFh.js";import{B as Fe}from"./bell-bbqgtkOi.js";import{C as Ne}from"./circle-alert-DYAS5zCb.js";import{S as Oe}from"./settings-Cr5328qy.js";import{U as Re}from"./user-check-DThu22cu.js";import"./authApi-DXuKah73.js";import"./adminApi-D06bCJ0k.js";/**
...
`,R=r.span`
  ...
  padding: 1px 5px;
  margin-right: 4px;
`,Io=({onClose:e})=>{const t=K(),p=n.useRef(null),[i,m]=n.useState(""),[u,l]=n.useState([]),[g,f]=n.useState([]),[y,h]=n.useState(!1),[j,b]=n.useState(0);n.useEffect(()=>{var s;(s=p.current)==null||s.focus()},[]),n.useEffect(()=>{let s=!1;return h(!0),uo().then(c=>{s||f(c.data||[])}).catch(()=>{}).finally(()=>{s||h(!1)}),()=>{s=!0}},[]),n.useEffect(()=>{if(!i.trim()){l(g.slice(0,8)),b(0);return}const s=i.toLowerCase(),c=g.filter(v=>(v.name||"").toLowerCase().includes(s)||(v.type||"").toLowerCase().includes(s)||(v.assetType||"").toLowerCase().includes(s)).slice(0,10);l(c),b(0)},[i,g]);const $=n.useCallback(s=>{if(s.key==="Escape"){e();return}s.key==="ArrowDown"&&(s.preventDefault(),b(c=>Math.min(c+1,u.length-1))),s.key==="ArrowUp"&&(s.preventDefault(),b(c=>Math.max(c-1,0))),s.key==="Enter"&&u[j]&&(e(),t("/dashboard/explore"))},[u,j,e,t]),S=()=>{e(),t("/dashboard/explore")};return o.jsx(fo,{onClick:e,children:o.jsxs(mo,{onClick:s=>s.stopPropagation(),onKeyDown:$,children:[o.jsxs(bo,{children:[o.jsx(yo,{children:o.jsx(X,{size:20})}),o.jsx(jo,{ref:p,placeholder:"Search stocks, mutual funds, or symbols...",value:i,onChange:s=>m(s.target.value)}),o.jsx($o,{onClick:e,children:"ESC"})]}),o.jsx(vo,{children:y?o.jsx(_,{children:"Loading funds..."}):u.length===0?o.jsx(_,{children:i?`No results for "${i}"`:"No funds available"}):u.map((s,c)=>o.jsxs(G,{$active:c===j,onClick:S,onMouseEnter:()=>b(c),children:[o.jsx(ko,{children:o.jsx(de,{size:18})}),o.jsxs(wo,{children:[o.jsx(Co,{children:s.name}),o.jsxs(So,{children:[s.type&&o.jsx("span",{children:s.type}),s.risk&&o.jsxs("span",{children:["• ",s.risk," Risk"]}),s.nav&&o.jsxs("span",{children:["• NAV ₹",s.nav]})]})]}),o.jsx(zo,{children:o.jsx(pe,{size:16})})]},s.id||c))}),o.jsxs(Mo,{children:[o.jsxs("span",{children:[o.jsx(R,{children:"↑↓"})," Navigate"]}),o.jsxs("span",{children:[o.jsx(R,{children:"↵"})," Select"]}),o.jsxs("span",{children:[o.jsx(R,{children:"Esc"})," Close"]})]})]})})},Fo=M`
  from { opacity: 0; }
  to   { opacity: 1; }
`,No=M`
