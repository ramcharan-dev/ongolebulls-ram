import{j as e,Q as o,r as A,X as pe,Y as he}from"./index-Bj-2qslO.js";const xe=o.section`
...
`,qe=o.div`
  margin-top: 10px;
`,Xe=[{key:"panCardImage",label:"PAN Card Image"},{key:"aadhaarFrontImage",label:"Aadhaar Front"},{key:"aadhaarBackImage",label:"Aadhaar Back"},{key:"signatureImage",label:"Signature Photo"}];function Ye({data:a,errors:n,onFileChange:r}){return e.jsxs(S,{children:[e.jsx(P,{children:"Identity Upload"}),e.jsx(w,{children:"Upload clear images for all mandatory documents."}),e.jsx(ze,{children:Xe.map(i=>{var h;const s=a[i.key]||null,d=(s==null?void 0:s.preview)||"";return e.jsxs(Ve,{children:[d?e.jsx(Le,{src:d,alt:`${i.label} preview`}):null,e.jsxs("strong",{children:[i.label," ",e.jsx(f,{children:"*"})]}),e.jsx("p",{children:((h=s==null?void 0:s.file)==null?void 0:h.name)||"Tap to upload image"}),e.jsx("input",{type:"file",accept:"image/*",onChange:b=>{var N;const x=(N=b.target.files)==null?void 0:N[0];x&&r(i.key,x)}})]},i.key)})}),n.documents?e.jsx(qe,{children:e.jsx(u,{children:n.documents})}):null]})}const Ge=o.label`
  margin-top: 18px;
  border: 1px dashed #cbd5e1;
  border-radius: 14px;
  background: #f8fafc;
...
`;function He({data:a,errors:n,onSelfieUpload:r}){var s,d,h;const i=(s=a==null?void 0:a.selfie)==null?void 0:s.preview;return e.jsxs(S,{children:[e.jsx(P,{children:"Live Selfie Verification"}),e.jsx(w,{children:"Please take a clear selfie for identity verification."}),e.jsxs(Ge,{children:[i?e.jsx(_e,{src:i,alt:"Selfie preview"}):null,e.jsx("strong",{children:i?"Retake Selfie":"Capture Selfie"}),e.jsx("p",{children:i?(h=(d=a==null?void 0:a.selfie)==null?void 0:d.file)==null?void 0:h.name:"Use front camera with clear lighting"}),e.jsx("input",{type:"file",accept:"image/*",capture:"user",onChange:b=>{var N;const x=(N=b.target.files)==null?void 0:N[0];x&&r(x)}})]}),n.selfie?e.jsx(u,{children:n.selfie}):null]})}const We=o.div`
  margin-top: 18px;
  display: grid;
  gap: 12px;
`,T=o.section`
