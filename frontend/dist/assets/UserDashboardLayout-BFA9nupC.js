import{n as C,j as o,l as ie,A as r,a8 as ae,N as le,r as n,c as ce,u as K,T as de,U as pe,_ as M,S as xe,a as ue,Q as he,O as ge}from"./index-BUtZQfg4.js";import{d as fe,l as me}from"./theme-CVoCgdjI.js";import{X as E}from"./x-BHSXGI30.js";import{L as be,a as ye}from"./log-out-DrPO23qn.js";import{R as je}from"./receipt-B5Or0Jpi.js";import{F as $e}from"./file-text-C_eVKXtv.js";import{U as W}from"./user-D3-M3mj9.js";import{S as ve,M as ke}from"./send-Bppp_VQd.js";import{S as Q}from"./search-D2Q26z9a.js";import{c as we}from"./userApi-CURgvn4g.js";import{u as V}from"./useAuth-B6l57m9g.js";import{C as Ce,S as Se}from"./sparkles-DPhh4dXt.js";import{C as ze}from"./chevron-down-BTbZ8hO1.js";import{S as Me,M as Ie}from"./sun-CeOHgnnU.js";import{B as Fe}from"./bell-BnCQ0rNc.js";import{C as Ne}from"./circle-alert-wyQv5fZu.js";import{S as Oe}from"./settings-LuUyFhNp.js";import{U as Re}from"./user-check-DPQCQyZP.js";import"./authApi-bgCLz67z.js";import"./adminApi-DCZJb2Pt.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Le=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3",key:"1u773s"}],["path",{d:"M12 17h.01",key:"p32p05"}]],X=C("circle-question-mark",Le);/**
 * @license lucide-react v0.576.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,Je=r.div`
  ...
  align-items: center;
  justify-content: center;
`,Ze=({isOpen:e,toggleSidebar:t})=>{const p=[{name:"Dashboard",path:"/dashboard",icon:o.jsx(be,{size:20})},{name:"Explore Funds",path:"/dashboard/explore",icon:o.jsx(ae,{size:20})},{name:"SIPs",path:"/dashboard/sips",icon:o.jsx(je,{size:20})},{name:"Statements",path:"/dashboard/statements",icon:o.jsx($e,{size:20})},{name:"My Profile",path:"/dashboard/profile",icon:o.jsx(W,{size:20})},{name:"Support / Help",path:"/dashboard/support",icon:o.jsx(X,{size:20})}];return o.jsxs(Ye,{$isOpen:e,children:[o.jsxs(Ke,{children:[o.jsxs(We,{children:[o.jsx("h1",{children:"OngoleBulls"}),o.jsx(Qe,{src:ie,alt:"OngoleBulls"})]}),o.jsx(Ve,{onClick:t,children:o.jsx(E,{size:20})})]}),o.jsx(Xe,{children:p.map(i=>o.jsxs(Ge,{to:i.path,end:i.path==="/dashboard",onClick:()=>{window.innerWidth<=1024&&t()},children:[o.jsx(Je,{children:i.icon}),i.name]},i.name))})]})},eo=r.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,R=r.span`
  ...
  padding: 1px 5px;
  margin-right: 4px;
`,Io=({onClose:e})=>{const t=K(),p=n.useRef(null),[i,m]=n.useState(""),[u,l]=n.useState([]),[g,f]=n.useState([]),[y,h]=n.useState(!1),[j,b]=n.useState(0);n.useEffect(()=>{var s;(s=p.current)==null||s.focus()},[]),n.useEffect(()=>{let s=!1;return h(!0),uo().then(c=>{s||f(c.data||[])}).catch(()=>{}).finally(()=>{s||h(!1)}),()=>{s=!0}},[]),n.useEffect(()=>{if(!i.trim()){l(g.slice(0,8)),b(0);return}const s=i.toLowerCase(),c=g.filter(v=>(v.name||"").toLowerCase().includes(s)||(v.type||"").toLowerCase().includes(s)||(v.assetType||"").toLowerCase().includes(s)).slice(0,10);l(c),b(0)},[i,g]);const $=n.useCallback(s=>{if(s.key==="Escape"){e();return}s.key==="ArrowDown"&&(s.preventDefault(),b(c=>Math.min(c+1,u.length-1))),s.key==="ArrowUp"&&(s.preventDefault(),b(c=>Math.max(c-1,0))),s.key==="Enter"&&u[j]&&(e(),t("/dashboard/explore"))},[u,j,e,t]),S=()=>{e(),t("/dashboard/explore")};return o.jsx(fo,{onClick:e,children:o.jsxs(mo,{onClick:s=>s.stopPropagation(),onKeyDown:$,children:[o.jsxs(bo,{children:[o.jsx(yo,{children:o.jsx(Q,{size:20})}),o.jsx(jo,{ref:p,placeholder:"Search stocks, mutual funds, or symbols...",value:i,onChange:s=>m(s.target.value)}),o.jsx($o,{onClick:e,children:"ESC"})]}),o.jsx(vo,{children:y?o.jsx(_,{children:"Loading funds..."}):u.length===0?o.jsx(_,{children:i?`No results for "${i}"`:"No funds available"}):u.map((s,c)=>o.jsxs(G,{$active:c===j,onClick:S,onMouseEnter:()=>b(c),children:[o.jsx(ko,{children:o.jsx(de,{size:18})}),o.jsxs(wo,{children:[o.jsx(Co,{children:s.name}),o.jsxs(So,{children:[s.type&&o.jsx("span",{children:s.type}),s.risk&&o.jsxs("span",{children:["• ",s.risk," Risk"]}),s.nav&&o.jsxs("span",{children:["• NAV ₹",s.nav]})]})]}),o.jsx(zo,{children:o.jsx(pe,{size:16})})]},s.id||c))}),o.jsxs(Mo,{children:[o.jsxs("span",{children:[o.jsx(R,{children:"↑↓"})," Navigate"]}),o.jsxs("span",{children:[o.jsx(R,{children:"↵"})," Select"]}),o.jsxs("span",{children:[o.jsx(R,{children:"Esc"})," Close"]})]})]})})},Fo=M`
  from { opacity: 0; }
  to   { opacity: 1; }
`,No=M`
...
`,xr=r.div`
  ...
  text-overflow: ellipsis;
  white-space: nowrap;
`,ur=[{label:"NIFTY 50",value:"24,560.10",change:"+294.70",pct:"+1.2%",positive:!0},{label:"SENSEX",value:"80,123.45",change:"+640.30",pct:"+0.8%",positive:!0}],hr=[{id:1,title:"KYC Verification Pending",time:"2 hours ago",unread:!0,icon:o.jsx(xe,{size:18}),bg:"rgba(245,158,11,0.1)",color:"#D97706"},{id:2,title:"Complete your UCC Registration",time:"1 day ago",unread:!0,icon:o.jsx(Re,{size:18}),bg:"rgba(59,130,246,0.1)",color:"#3B82F6"},{id:3,title:"Welcome to OngoleBulls!",time:"3 days ago",unread:!1,icon:o.jsx(Se,{size:18}),bg:"rgba(16,185,129,0.1)",color:"#10B981"}],gr=({toggleSidebar:e,toggleTheme:t,isDark:p})=>{const i=K(),{logout:m}=V(),[u,l]=n.useState(!1),[g,f]=n.useState(!1),[y,h]=n.useState(!1),[j,b]=n.useState(!1),[$,S]=n.useState(!1),[s,c]=n.useState(!1),[v,J]=n.useState(hr),[Z,ee]=n.useState("Investor"),[L,oe]=n.useState(""),[re,I]=n.useState("OB"),F=n.useRef(null),N=n.useRef(null),O=n.useRef(null);n.useEffect(()=>{const a=localStorage.getItem("ob_user");let x="Investor",P="";if(a)try{const d=JSON.parse(a);d!=null&&d.fullName?x=d.fullName:d!=null&&d.name?x=d.name:d!=null&&d.username&&(x=d.username),d!=null&&d.email&&(P=d.email)}catch{}ee(x),oe(P);const k=x.trim().split(/\s+/);k.length>=2?I((k[0][0]+k[1][0]).toUpperCase()):k.length===1&&k[0].length>0?I(k[0].substring(0,2).toUpperCase()):I("OB")},[]),n.useEffect(()=>{const a=x=>{F.current&&!F.current.contains(x.target)&&l(!1),N.current&&!N.current.contains(x.target)&&S(!1),O.current&&!O.current.contains(x.target)&&c(!1)};return document.addEventListener("mousedown",a),()=>document.removeEventListener("mousedown",a)},[]),n.useEffect(()=>{const a=x=>{(x.metaKey||x.ctrlKey)&&x.key==="k"&&(x.preventDefault(),h(!0))};return document.addEventListener("keydown",a),()=>document.removeEventListener("keydown",a)},[]);const te=()=>{l(!1),f(!0)},se=()=>{J(a=>a.map(x=>({...x,unread:!1})))},ne=async()=>{c(!1),await m(),i("/login")},A=v.filter(a=>a.unread).length;return o.jsxs(o.Fragment,{children:[o.jsxs(_o,{children:[o.jsxs(qo,{children:[o.jsx(Ho,{onClick:e,children:o.jsx(_e,{size:24})}),o.jsxs(Yo,{onClick:()=>h(!0),children:[o.jsx(Q,{size:18,color:"currentColor"}),o.jsx(Ko,{children:"Search stocks, funds, or symbols..."}),o.jsxs(Wo,{children:[o.jsx(Pe,{size:11}),"K"]})]})]}),o.jsx(Qo,{children:ur.map(a=>o.jsxs(Vo,{children:[o.jsx("span",{className:"label",children:a.label}),o.jsxs("span",{className:`value ${a.positive?"up":"down"}`,children:[a.value," ",a.positive?o.jsx(Ce,{size:14}):o.jsx(ze,{size:14})," ",a.pct]})]},a.label))}),o.jsxs(Xo,{children:[o.jsxs(Zo,{children:[o.jsx(Go,{onClick:()=>i("/dashboard/explore"),children:"Invest"}),o.jsx(Jo,{onClick:()=>b(!0),children:"Redeem"})]}),o.jsx(D,{onClick:t,title:"Toggle Theme",children:p?o.jsx(Me,{size:20}):o.jsx(Ie,{size:20})}),o.jsxs(B,{ref:N,children:[o.jsxs(D,{title:"Notifications",onClick:()=>S(!$),children:[o.jsx(Fe,{size:20}),A>0&&o.jsx(er,{})]}),o.jsxs(T,{$isOpen:$,$width:"320px",children:[o.jsxs(or,{children:[o.jsx("h4",{children:"Notifications"}),A>0&&o.jsx(rr,{onClick:se,children:"Mark all read"})]}),v.map(a=>o.jsxs(tr,{$unread:a.unread,children:[o.jsx(sr,{$bg:a.bg,$color:a.color,children:a.icon}),o.jsxs(nr,{children:[o.jsx(ir,{children:a.title}),o.jsx(ar,{children:a.time})]}),a.unread&&o.jsx(lr,{})]},a.id))]})]}),o.jsxs(B,{ref:F,children:[o.jsx(D,{title:"Help & Support",onClick:()=>l(!u),children:o.jsx(X,{size:20})}),o.jsxs(T,{$isOpen:u,children:[o.jsxs(w,{onClick:te,children:[o.jsx(Ne,{size:18}),"Raise Support Ticket"]}),o.jsx(Y,{}),o.jsxs(w,{onClick:()=>{l(!1),i("/dashboard/support")},children:[o.jsx(ke,{size:18}),"Contact Support"]}),o.jsxs(w,{onClick:()=>{l(!1),i("/dashboard/support")},children:[o.jsx(Be,{size:18}),"FAQ"]})]})]}),o.jsxs(B,{ref:O,children:[o.jsx(cr,{onClick:()=>c(!s),children:re}),o.jsxs(T,{$isOpen:s,$width:"260px",children:[o.jsxs(dr,{children:[o.jsx(pr,{children:Z}),L&&o.jsx(xr,{children:L})]}),o.jsxs(w,{onClick:()=>{c(!1),i("/dashboard/profile")},children:[o.jsx(W,{size:18}),"My Profile"]}),o.jsxs(w,{onClick:()=>{c(!1),i("/dashboard/support")},children:[o.jsx(Oe,{size:18}),"Settings"]}),o.jsx(Y,{}),o.jsxs(w,{$color:"#DC2626",onClick:ne,children:[o.jsx(ye,{size:18}),"Sign Out"]})]})]})]})]}),g&&o.jsx(xo,{onClose:()=>f(!1)}),y&&o.jsx(Io,{onClose:()=>h(!1)}),j&&o.jsx(Uo,{onClose:()=>b(!1)})]})},fr=r.div`
  display: flex;
  min-height: 100vh;
  width: 100%;
  background-color: ${({theme:e})=>e.colors.background};
