import{n as ts,c as S,a as Is,u as Ds,r,j as e,Q as Ms,S as _e,A as n}from"./index-CBdPhbzg.js";import{d as Ps,l as Bs}from"./theme-CVoCgdjI.js";import{C as w}from"./check-COpnCwI4.js";import{C as Ge}from"./circle-alert-DYAS5zCb.js";import{a as Us,L as _s}from"./log-out-XNb9afVR.js";import{S as Gs,M as Vs}from"./sun-CvwvmJFh.js";import{X as k}from"./x-C3hjsG26.js";import{F as Ve}from"./file-check-IKVTTW-F.js";import{S as Ys}from"./search-ejUTuyX_.js";import{R as re}from"./refresh-cw-D3uugpiT.js";import{P as Ws}from"./plus-BczYa6Gw.js";import{I as Hs}from"./inbox-BNPj5Wsn.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const qs=[["path",{d:"M15 12h-5",key:"r7krc0"}],["path",{d:"M15 8h-5",key:"1khuty"}],["path",{d:"M19 17V5a2 2 0 0 0-2-2H4",key:"zz82l3"}],["path",{d:"M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a2 2 0 1 1-4 0V5a2 2 0 1 0-4 0v2a1 1 0 0 0 1 1h3",key:"1ph1d7"}]],Ye=ts("scroll-text",qs),m={getStats:()=>S.get("/api/compliance/stats"),getAuditLogs:s=>S.get("/api/compliance/audit-logs",{params:s}),getFlags:s=>S.get("/api/compliance/flags",{params:s}),raiseFlag:s=>S.post("/api/compliance/flags",s),resolveFlag:(s,o)=>S.patch(`/api/compliance/flags/${s}/resolve`,{notes:o}),getRiskSummary:()=>S.get("/api/compliance/partners/risk-summary"),getDisclosures:()=>S.get("/api/compliance/disclosures")},Q=s=>{if(!s)return"—";try{return new Date(s).toLocaleDateString("en-IN",{day:"2-digit",month:"short",year:"numeric"})}catch{return"—"}},oe=s=>{if(!s)return"—";try{return new Date(s).toLocaleString("en-IN",{day:"2-digit",month:"short",year:"numeric",hour:"2-digit",minute:"2-digit"})}catch{return"—"}},Ks=n.div`
  display: flex;
  min-height: 100vh;
